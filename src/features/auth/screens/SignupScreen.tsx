...
type Nav = AuthScreenProps<'Signup'>['navigation'];
...
function SignupScreen() {
  ...
  const countryList = getAllCountries().map((c: any) => ({
          ...
          <View style={styles.form}>
            {showSetPassword ? (
              <SetNewPasswordScreen
                ...
                token={verifiedToken}
                onPasswordSet={() => navigation.navigate('Login')}
                onBackPress={() => {
              ...
              <EmailVerificationScreen
                ...
                onOtpVerified={(data: { token: string; clientId: string }) => {
                ...
                <View style={styles.row}>
                  <View
                    ...
                    <Picker
                      ...
                      dropdownIconColor={colors.inputPlaceholder}>
                      {countryList.map((c: { label: string; value: string; key: string }) => (
