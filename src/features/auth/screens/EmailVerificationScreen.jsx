      ...
      if (token) {
        ...
        if (!onOtpVerified) {
          const nextParams = {
            ...
            clientId,
            token,
            companyId: route?.params?.companyId || route?.params?.company_id,
            totalAmount: route?.params?.totalAmount ?? route?.params?.total_amount,
            pricingType: route?.params?.pricingType,
