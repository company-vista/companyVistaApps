...
const styles = StyleSheet.create({
  ...
  remoteButton: { position: 'absolute', top: 98, left: 20, backgroundColor: 'rgba(201, 168, 76, 0.15)', borderWidth: 1, borderColor: 'rgba(201, 168, 76, 0.3)', borderRadius: 20, paddingHorizontal: s(14), paddingVertical: s(6), zIndex: 10 },
  ...
  badgeLive: { fontSize: 10, fontWeight: '700', color: '#3b82f6', letterSpacing: 1, marginBottom: s(4) },
  ...
  badgeAvailable: { fontSize: 8, fontWeight: '700', color: '#c9a84c', letterSpacing: 1, marginBottom: s(2) },
  badgeNumber: { fontSize: 28, fontWeight: '300', color: '#c9a84c', marginBottom: s(2) },
  badgeCountries: { fontSize: 9, color: 'rgba(255, 255, 255, 0.4)' },
  stepperContainer: { alignItems: 'center', justifyContent: 'center', width: '100%', paddingHorizontal: s(30), marginTop: -8, marginBottom: s(10) },
  ...
  stepperLabel: { fontSize: 9, fontWeight: '500', color: 'rgba(255, 255, 255, 0.6)', marginTop: s(6), textAlign: 'center' },
  ...
  eyebrowContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: s(10) },
  eyebrowDash: { width: 18, height: 1, backgroundColor: '#c9a84c', marginRight: s(8) },
  eyebrowText: { fontSize: 10, fontWeight: '700', letterSpacing: 1.5, color: '#c9a84c' },
  title: { fontSize: 24, color: '#f5f3ee', fontWeight: '300', lineHeight: 30, marginBottom: s(12) },
  titleItalic: { fontStyle: 'italic', color: '#c9a84c' },
  body: { fontSize: 12, color: 'rgba(255, 255, 255, 0.48)', lineHeight: 20, marginBottom: 'auto' },
  dotsContainer: { flexDirection: 'row', alignItems: 'center', gap: 7, marginBottom: s(20) },
  dot: { width: 6, height: 6, borderRadius: 3, backgroundColor: 'rgba(255, 255, 255, 0.15)' },
  activeDot: { width: 22, backgroundColor: '#c9a84c', borderRadius: 4 },
  nextButton: { borderRadius: 24, overflow: 'hidden', marginBottom: s(10) },
