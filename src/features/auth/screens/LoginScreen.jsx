...
import { clearLoginError, loginUser, googleLoginUser, } from '../../../store/slices/authSlice';
...
function LoginScreen() {
    ...
    return (<KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={[
      ...
      <View style={styles.container}>
        ...
        <View style={styles.form}>
        ...
        }} placeholder="Enter password" placeholderTextColor={colors.inputPlaceholder} secureTextEntry={!isPasswordVisible} style={[styles.input, { color: colors.inputText }]} value={password}/>
              <Pressable accessibilityLabel={isPasswordVisible ? 'Hide password' : 'Show password'} accessibilityRole="button" onPress={() => setIsPasswordVisible(current => !current)} style={styles.passwordToggle}>
                <FontAwesome name={isPasswordVisible ? 'eye-slash' : 'eye'} size={18} color={colors.subtle}/>
              </Pressable>
            </View>
          ...
          <Pressable disabled={isLoading} onPress={handleGoogleSignIn} style={[
