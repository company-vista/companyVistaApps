    ...
    return (<ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[
      ...
      <View style={[styles.detailsCard, { backgroundColor: colors.surface }]}>
        ...
        <View>
          ...
          {isEmailDropdownOpen && (<View style={[styles.emailDropdown, { backgroundColor: colors.surfaceAlt, borderColor: colors.border }]}>
              {emailList.map((item, index) => (<View key={item.email + index} style={[styles.emailDropdownItem, index < emailList.length - 1 && { borderBottomWidth: 1, borderBottomColor: colors.border }]}>
                  {editingIndex === index ? (<View style={styles.emailEditRow}>
                      ...
                      {item.isPrimary ? (<Pressable onPress={() => setIsAddingEmail(true)} style={[styles.emailDropdownAdd, { backgroundColor: colors.accentSoft }]}>
                        ...
                        </Pressable>) : (<Pressable onPress={() => { setEditingIndex(index); setEditingEmail(item.email); }} style={[styles.emailDropdownAdd, { backgroundColor: colors.surfaceAlt, borderWidth: 1, borderColor: colors.border }]}>
      ...
      <Pressable onPress={() => navigation.navigate('ProfileAddress')} style={[styles.addressCard, { backgroundColor: colors.surface }]}>
        <View style={[styles.detailIcon, { backgroundColor: colors.surfaceAlt }]}>
