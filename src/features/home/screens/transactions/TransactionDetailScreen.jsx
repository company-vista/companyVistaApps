...
<body>
  <div style="border:1px solid #e2e8f0; max-width:600px; margin:0 auto; overflow:hidden;">
    ...
    return (<View style={[styles.screen, { paddingTop: safeAreaInsets.top + 8 }]}>
      {/* Header */}
      ...
      <ScrollView contentContainerStyle={{
        ...
        <Text style={[styles.amountValue, { color: colors.text }]}>
          ...
          <View style={styles.amountBreakdown}>
            {(transaction.paymentMethod === 'stripe' || transaction.paymentMethod === 'razorpay') && (<View style={[styles.amountModeCard, { backgroundColor: 'rgba(37, 99, 235, 0.1)' }]}>
            ...
            {transaction.paymentMethod === 'cash' && (<View style={[styles.amountModeCard, { backgroundColor: 'rgba(5, 150, 105, 0.1)' }]}>
        ...
        {/* Description & Notes */}
        {(transaction.description || transaction.notes) && (<View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: colors.text }]}>Additional Information</Text>

            {transaction.description && (<DetailRow label="Description" value={transaction.description} colors={colors}/>)}
        ...
        <View style={styles.section}>
          ...
          <DetailRow label="Created At" value={formatDate(transaction.createdAt)} colors={colors}/>
          <DetailRow label="Updated At" value={formatDate(transaction.updatedAt)} colors={colors}/>
