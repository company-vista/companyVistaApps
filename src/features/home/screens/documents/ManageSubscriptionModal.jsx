...
export default function ManageSubscriptionModal({ visible, onClose }) {
    const colors = useThemeColors();
    const isDark = colors.mode === 'dark';
    return (<Modal animationType="fade" transparent={true} visible={visible} onRequestClose={onClose} statusBarTranslucent={true}>
        ...
        <View style={[styles.modalContainer, { backgroundColor: colors.background }]}>
          <View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
              ...
              {PLANS_DATA.map((plan) => (<View key={plan.id} style={[
                styles.planCard,
                ...
                plan.isActive && styles.activeCardBorder,
                  ...
                  {plan.badge && (<View style={[styles.badge, { backgroundColor: plan.badgeBg }]}>
                  ...
                  <View style={styles.cardMain}>
                    <View style={[styles.iconCircle, { backgroundColor: `${plan.accentColor}15` }]}>
                      <FontAwesome name={plan.id === 'enterprise' ? 'shield' : 'file-text'} size={18} color={plan.accentColor}/>
                    </View>
                  ...
                  <View style={styles.cardBottomAction}>
                    {plan.isActive ? (<View style={styles.activeLabelRow}>
                        <FontAwesome name="check-circle" size={16} color="#10B981" style={{ marginRight: 6 }}/>
                        <Text style={styles.activeButtonText}>Active</Text>
                      </View>) : (<Pressable style={[styles.subscribeBtn, { backgroundColor: plan.accentColor }]}>
