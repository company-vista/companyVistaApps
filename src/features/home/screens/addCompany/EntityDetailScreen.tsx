...
const entityOptionsByCountry: Record<string, string[]> = {
      ...
      <View style={styles.body}>
        ...
        >
          ...
          <View style={[styles.fieldGroup, { marginTop: 14 }]}>
            ...
            <View style={[styles.inputWrapper, { backgroundColor: inputBg, borderColor: colors.inputBorder }]}>
              <TextInput
                ...
                value={companyName}
                onChangeText={(v) => { setCompanyName(v); setAttemptedSubmit(false); }}
              />
            </View>
          ...
          <View style={[styles.fieldGroup, { marginTop: 20 }]}>
            ...
            <View style={[styles.inputWrapper, { backgroundColor: inputBg, borderColor: colors.inputBorder }]}>
              <TextInput
                placeholder="e.g. Atlas Global Trading"
                placeholderTextColor={colors.inputPlaceholder}
                style={[styles.input, { color: colors.text }]}
                value={alternateName}
                onChangeText={(v) => { setAlternateName(v); setAttemptedSubmit(false); }}
              />
            </View>
