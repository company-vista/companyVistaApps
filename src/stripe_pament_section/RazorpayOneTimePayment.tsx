...
interface RazorpayOneTimePaymentProps {
  invoice?: InvoiceData;
  onSuccess?: (data: any) => void;
  onInitiated?: (data: any) => void;
...
function pollPaymentStatus(invoiceId: string) {
  ...
  paymentStatusInterval = setInterval(async () => {
    ...
    try {
      const { data } = await axios.get(
        `${API_BASE_URL}/api/subscription/details/${invoiceId}`,
        {
...
export default function RazorpayOneTimePayment({
  invoice = {},
  onSuccess,
  onInitiated,
  paymentType = 'invoice',
